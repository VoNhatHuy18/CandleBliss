                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        {isLoading ? (
                            ...
                            <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed border-gray-300 rounded-lg">
                                ...
                                {searchTerm ? (
                                    <>
                                        <h3 className="text-lg font-medium text-gray-700 mb-1">Không tìm thấy danh mục</h3>
                                    ...
                                    <>
                                        <h3 className="text-lg font-medium text-gray-700 mb-1">Chưa có danh mục nào</h3>
                                        <p className="text-sm text-gray-500 mb-4 text-center">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md animate-fade-in-up">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-6">
                                ...
                                />
                                <p className="mt-1 text-xs text-gray-500">Mô tả ngắn gọn về danh mục sẽ giúp người dùng hiểu rõ hơn.</p>
                            </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md animate-fade-in-up">
                        ...
                        <p className="mb-6 text-gray-600">
                            Bạn có chắc chắn muốn xóa danh mục <span className="font-semibold">{currentCategory?.name}</span>? Hành động này không thể hoàn tác.
                        </p>
