        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
            <div className="text-center">
                ...
                <div className="mb-6 text-gray-600 space-y-4">
                    <p>
                        Chúng tôi đã gửi một email xác nhận đến <span className="font-medium text-gray-900">{email}</span>.
                    </p>
                    <p>
                        Vui lòng kiểm tra hộp thư đến và nhấp vào liên kết xác nhận trong email để hoàn tất quá trình đăng ký.
                    </p>
                    <div className="border-l-4 border-orange-200 bg-orange-50 p-4 text-sm text-left">
                        <p>
                            <span className="font-medium">Lưu ý:</span> Nếu bạn không thấy email trong hộp thư đến, vui lòng kiểm tra thư mục Spam hoặc Thư rác.
                        </p>
                    </div>
                </div>
                    ...
                    <ol className="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li aria-current="page">
                            <div className="flex items-center">
                                ...
                                <span className="ml-1 text-sm font-medium text-orange-600 md:ml-2">Xác nhận email</span>
                            </div>
                        </li>
                    </ol>
                </nav>
