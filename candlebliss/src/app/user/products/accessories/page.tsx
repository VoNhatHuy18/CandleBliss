                     ...
                     {searchQuery ? (
                        <div>
                           <p className='text-gray-600 mb-4'>
                              Không tìm thấy sản phẩm phụ kiện phù hợp với &ldquo;{searchQuery}
                              &rdquo;
                           </p>
                           <Link href='/user/products/accessories'>
                        ...
                        <p className='text-gray-500'>Hiện không có sản phẩm phụ kiện nào</p>
                     )}
                  </div>
               )}
