      ...
      <div className="w-full md:w-1/4">
         ...
         <div className="mt-4 bg-white p-5 rounded-lg border shadow-sm">
            ...
            <div className="flex space-x-2">
               <Link href="/user/profile/support" className="text-amber-600 hover:text-amber-700 text-sm font-medium">
                  Liên hệ ngay
               </Link>
               <span className="text-gray-400">|</span>
               <Link href="/faq" target="_blank" className="text-amber-600 hover:text-amber-700 text-sm font-medium">
                  Câu hỏi thường gặp
               </Link>
            </div>
         </div>
