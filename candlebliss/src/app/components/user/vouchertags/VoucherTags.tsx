                    ...
                    <div className='flex-1 p-4'>
                        ...
                        <div className='text-xs text-gray-600 mb-2 flex flex-wrap gap-2'>
                            <div className='bg-gray-100 px-2 py-1 rounded-md'>
                                Đơn tối thiểu: <span className='font-semibold'>{formatCurrency(minOrderValue)}</span>
                            </div>
                            <div className='bg-gray-100 px-2 py-1 rounded-md'>
                                Giảm tối đa: <span className='font-semibold'>{formatCurrency(maxVoucherAmount)}</span>
                            </div>
                        </div>
